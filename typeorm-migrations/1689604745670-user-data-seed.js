...
module.exports = class userDataSeed1689604745670 {
  async up(queryRunner) {
    await queryRunner.query(`
                            ...
                            INSERT INTO auth.person (id, status, created_at, updated_at, deleted_at, uuid) VALUES (1, '1', '2023-07-06 16:49:21.154', '2023-07-06 16:49:21.154', NULL, '220ab7d5-9045-40f5-9689-fb011d8e263a');
                            insert into auth.users_groups (id, name,status) values (1,'group_app',1);
                            INSERT INTO auth.users (id, status, created_at, updated_at, deleted_at, username, "password", verification_code, person_id, uuid) VALUES (1, '1', '2023-07-06 16:49:21.154', '2023-07-11 02:49:17.517', NULL, 'devuser', 'no_password', 'M426TA', 1, '90120c3d-4a8d-4421-a3ac-5d03a2fb53d8');
                            insert into auth.users_groups_user (user_id,user_group_id,main,status) values (1,1,1,1);
                            INSERT INTO auth.person_contacts_type (id, status, created_at, updated_at, deleted_at, description, uuid) VALUES(1, '1', '2023-07-11 00:41:06.511', '2023-07-11 00:41:06.511', NULL, 'EMAIL', NULL);
                            INSERT INTO auth.person_contacts (id, status, created_at, updated_at, deleted_at, description, main, person_id, person_contact_type_id, uuid) VALUES (1, '1', '2023-07-11 00:45:23.075', '2023-07-11 00:45:23.075', NULL, 'jefferson.wendhel@swalliance.com.br', '1', 1, 1, '5a271d23-375d-462c-8eb7-cbad6f97379b');

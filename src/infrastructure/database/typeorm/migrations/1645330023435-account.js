...
module.exports = class account1645330023435 {
  name = 'account1645330023435';

  async up(queryRunner) {
    await queryRunner.query(
      `CREATE TABLE "movement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "value" numeric(10,2) NOT NULL, "account_id" uuid, CONSTRAINT "REL_d91b6304186711230e9cab2bb4" UNIQUE ("account_id"), CONSTRAINT "PK_079f005d01ebda984e75c2d67ee" PRIMARY KEY ("id")); COMMENT ON COLUMN "movement"."created_at" IS 'data de criacao do registro'; COMMENT ON COLUMN "movement"."value" IS 'valor do saldo'`,
    );
    await queryRunner.query(
